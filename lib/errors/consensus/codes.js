...
const DuplicateDocumentTransitionsError = require('./basic/document/DuplicateDocumentTransitionsWithIdsError');
...
const IdentityAssetLockProofMismatchError = require('./basic/identity/IdentityAssetLockProofLockedTransactionMismatchError');
...
const InvalidIdentityAssetLockProofError = require('./basic/identity/InvalidInstantAssetLockProofError');
const InvalidIdentityAssetLockProofSignatureError = require('./basic/identity/InvalidInstantAssetLockProofSignatureError');
