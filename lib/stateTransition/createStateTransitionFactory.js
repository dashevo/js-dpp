...
const AbstractDocumentActionTransition = require('../document/stateTransition/actionTransition/AbstractDocumentActionTransition');
const DocumentCreateTransition = require('../document/stateTransition/actionTransition/DocumentCreateTransition');
const DocumentReplaceTransition = require('../document/stateTransition/actionTransition/DocumentReplaceTransition');
const DocumentDeleteTransition = require('../document/stateTransition/actionTransition/DocumentDeleteTransition');
  ...
  function createStateTransition(rawStateTransition) {
    ...
    switch (rawStateTransition.type) {
      ...
      case types.DOCUMENTS: {
        const documentActionTransitions = rawStateTransition.transitions
          .map((rawDocumentActionTransition) => {
