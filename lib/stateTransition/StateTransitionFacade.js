...
const applyFactory = require('../stateTransition/applyFactory');

const applyDataContractStateTransitionFactory = require(
  '../dataContract/stateTransition/applyDataContractStateTransitionFactory',
);
const applyDataContractStateTransitionToModel = require(
  '../dataContract/stateTransition/applyDataContractStateTransitionToModel',
);

const applyDocumentsBatchTransitionFactory = require(
  '../document/stateTransition/applyDocumentsBatchTransitionFactory',
);
const applyDocumentsBatchTransitionToModels = require(
  '../document/stateTransition/applyDocumentsBatchTransitionToModels',
);

const applyIdentityStateTransitionFactory = require(
  '../identity/stateTransitions/applyIdentityStateTransitionFactory',
);
const applyIdentityStateTransitionToModelFactory = require(
  '../identity/stateTransitions/applyIdentityStateTransitionToModelFactory',
);
...
class StateTransitionFacade {
  ...
  constructor(stateRepository, validator) {
    ...
    const applyDataContractStateTransition = applyDataContractStateTransitionFactory(
      stateRepository,
      applyDataContractStateTransitionToModel,
    );
    ...
    const applyIdentityStateTransitionToModel = applyIdentityStateTransitionToModelFactory(
      getLockedTransactionOutput,
    );
    const applyIdentityStateTransition = applyIdentityStateTransitionFactory(
      stateRepository,
      applyIdentityStateTransitionToModel,
    );

    this.applyStateTransition = applyFactory(
