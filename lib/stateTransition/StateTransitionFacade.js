...
const validateIdentityTopUpSTDataFactory = require('../identity/stateTransitions/identityTopUpTransition/validateIdentityTopUpTransitionDataFactory');
...
const validateIdentityTopUpSTStructureFactory = require('../identity/stateTransitions/identityTopUpTransition/validateIdentityTopUpTransitionStructureFactory');
...
class StateTransitionFacade {
  ...
  constructor(stateRepository, validator, enableLockTxOneBlockConfirmationFallback = undefined) {
    ...
    const validateIdentityTopUpSTStructure = validateIdentityTopUpSTStructureFactory();
    ...
    const typeExtensions = {
      ...
      [stateTransitionTypes.IDENTITY_TOP_UP]: {
        validationFunction: validateIdentityTopUpSTStructure,
    ...
    const validateIdentityTopUpSTData = validateIdentityTopUpSTDataFactory(
      validateLockTransaction,
      validateIdentityExistence,
    );
    ...
    this.validateStateTransitionData = validateStateTransitionDataFactory({
      ...
      [stateTransitionTypes.IDENTITY_TOP_UP]: validateIdentityTopUpSTData,
    });
