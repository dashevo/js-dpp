...
const createStateTransitionFromJSONFactory = require('./createStateTransitionFromJSONFactory');
const createStateTransitionFromObjectFactory = require('./createStateTransitionFromObjectFactory');
...
class StateTransitionFacade {
  ...
  constructor(stateRepository, validator, skipAssetLockConfirmationValidation = false) {
    ...
    this.createStateTransitionFromJSON = createStateTransitionFromJSONFactory(stateRepository);
    this.createStateTransitionFromObject = createStateTransitionFromObjectFactory(stateRepository);
    ...
    this.validateStateTransitionStructure = validateStateTransitionStructureFactory(
      validator,
      typeExtensions,
      this.createStateTransitionFromJSON,
    );
    ...
    this.factory = new StateTransitionFactory(
      ...
      this.createStateTransitionFromJSON,
      this.createStateTransitionFromObject,
    );
  ...
  async validate(stateTransition) {
    ...
    if (!(stateTransition instanceof AbstractStateTransition)) {
      stateTransitionModel = this.createStateTransitionFromJSON(stateTransition);
    }
