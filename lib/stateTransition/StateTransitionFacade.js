...
const validateDocumentsBatchTransitionStructure = require('../document/stateTransition/validation/structure/validateDocumentsBatchTransitionStructure');
...
class StateTransitionFacade {
  ...
  constructor(dataProvider, validator) {
    ...
    const validateDocumentsSTStructure = validateDocumentsBatchTransitionStructure(
      validateDocument,
      findDuplicatesById,
