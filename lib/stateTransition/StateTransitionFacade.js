...
const InstantAssetLockProof = require('../identity/stateTransitions/assetLock/proof/instant/InstantAssetLockProof');
const ChainAssetLockProof = require('../identity/stateTransitions/assetLock/proof/chain/ChainAssetLockProof');
const validateChainAssetLockProofStructureFactory = require('../identity/stateTransitions/assetLock/proof/chain/validateChainAssetLockProofStructureFactory');
