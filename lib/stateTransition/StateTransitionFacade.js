...
class StateTransitionFacade {
  ...
  constructor(stateRepository, validator, skipAssetLockConfirmationValidation = false) {
    ...
    this.createStateTransitionFromJSON = createStateTransitionFactory(stateRepository, {
      asJSON: true,
    });
    this.createStateTransitionFromObject = createStateTransitionFactory(stateRepository, {
      asJSON: false,
    });
