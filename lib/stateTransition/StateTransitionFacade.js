...
class StateTransitionFacade {
   ...
   * @return {DataContractCreateTransition|DocumentsStateTransition}
   */
   ...
   *
   * @param {
   *  DataContractCreateTransition|DocumentsStateTransition|IdentityCreateTransition
   *  |RawDataContractCreateTransition|RawDocumentsStateTransition|RawIdentityCreateTransition
   *  } stateTransition
   * @return {ValidationResult}
   */
