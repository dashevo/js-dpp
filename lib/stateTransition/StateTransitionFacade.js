...
const validateIdentityCreateSTDataFactory = require('../identity/stateTransitions/validation/data/validateIdentityCreateSTDataFactory');
const validateIdentityCreateSTStructureFactory = require('../identity/stateTransitions/validation/structure/validateIdentityCreateSTStructureFactory');
...
const validateIdentityTypeFactory = require('./validation/validateIdentityTypeFactory');
...
class StateTransitionFacade {
  ...
  constructor(dataProvider, validator) {
    ...
    const validateIdentityCreateSTStructure = validateIdentityCreateSTStructureFactory(validator);
    ...
    const typeExtensions = {
      ...
      [stateTransitionTypes.IDENTITY_CREATE]: {
        ...
        schema: identityCreateStateTransitionSchema,
      },
    };
    ...
    const validateIdentityType = validateIdentityTypeFactory(dataProvider);
