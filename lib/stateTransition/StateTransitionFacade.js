...
const dataContractStateTransitionSchema = require('../../schema/dataContract/stateTransition/dataContract');
const documentsBatchStateTransitionSchema = require('../../schema/document/stateTransition/documentsBatch');
