...
const validateDuplicatePublicKeys = require('../identity/validation/validateDuplicatePublicKeys');
const validatePublicKeys = require('../identity/validation/validatePublicKeys');
