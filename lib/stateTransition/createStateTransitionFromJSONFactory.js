 ...
 *
 * @return {createStateTransitionFromJSON}
 */
function createStateTransitionFromJSONFactory(stateRepository) {
  /**
   * @typedef createStateTransitionFromJSON
   *
   * @param {
   ...
   * }
   */
  async function createStateTransitionFromJSON(rawStateTransition) {
...
module.exports = createStateTransitionFromJSONFactory;
