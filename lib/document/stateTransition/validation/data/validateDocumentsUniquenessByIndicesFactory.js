 ...
 */
function validateDocumentsUniquenessByIndicesFactory(fetchDocuments, dataProvider) {
  /**
   ...
   */
  async function validateDocumentsUniquenessByIndices(documents, userId, dataContract) {
