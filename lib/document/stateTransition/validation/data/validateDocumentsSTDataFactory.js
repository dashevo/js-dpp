...
const DocumentIdComponentsMismatchError = require(
  '../../../../errors/DocumentIdComponentsMismatchError',
);
...
function validateDocumentsSTDataFactory(
  ...
  async function validateDocumentsSTData(stateTransition) {
    ...
    const ownerId = firstDocument.getOwnerId();
        ...
        switch (document.getAction()) {
          ...
          case Document.ACTIONS.DELETE: {
            ...
            if (fetchedDocument.getOwnerId() !== document.getOwnerId()
              || fetchedDocument.getDataContractId() !== document.getDataContractId()
              || fetchedDocument.entropy !== document.entropy) {
              result.addError(
                new DocumentIdComponentsMismatchError(document, fetchedDocument),
              );
            }
