 ...
 */
function validateDocumentsBatchTransitionStructure(
  validateDocument,
  findDuplicatesById,
  ...
  async function validateDocumentsSTStructure(rawStateTransition) {
    ...
    const enrichedCreateDataContract = enrichDataContractWithBaseSchema(
      enrichedBaseDataContract,
      createTransitionSchema,
    );

    const enrichedReplaceDataContract = enrichDataContractWithBaseSchema(
      enrichedBaseDataContract,
    ...
    createTransitions
      ...
      .forEach((rawTransition) => {
        ...
        const enrichedDataContract = (
          rawTransition.$action === AbstractDocumentTransition.ACTIONS.CREATE
            ? enrichedCreateDataContract : enrichedReplaceDataContract
        );
...
module.exports = validateDocumentsBatchTransitionStructure;
