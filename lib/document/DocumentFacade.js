...
const createSubTransitions = require('./stateTransition/subTransition/createSubTransitions');
...
class DocumentFacade {
  ...
  createStateTransition(contractId, ownerId, subTransitionsMap) {
    return this.factory.createStateTransition(contractId, ownerId, subTransitionsMap);
  }
