...
class DocumentFactory {
   ...
   */
  createStateTransition(contractId, ownerId, subTransitionsMap) {
    const rawSubTransitions = this.createSubTransitions(subTransitionsMap)
      .map((st) => st.toJSON());

    return new DocumentsStateTransition({
      contractId,
      ownerId,
      subTransitions: rawSubTransitions,
    });
  }
}
