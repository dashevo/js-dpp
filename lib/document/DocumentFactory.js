...
const DocumentReplaceTransition = require('./stateTransition/documentTransition/DocumentReplaceTransition');
const DocumentDeleteTransition = require('./stateTransition/documentTransition/DocumentDeleteTransition');
  ...
  createStateTransition(documents) {
    ...
    const documentCreateTransitions = (createDocuments || [])
      .map((document) => {
        ...
        return new DocumentCreateTransition({
          $id: document.getId(),
