...
const CreateSubTransition = require('./stateTransition/subTransition/CreateSubTransition');
const ReplaceSubTransition = require('./stateTransition/subTransition/ReplaceSubTransition');
const DeleteSubTransition = require('./stateTransition/subTransition/DeleteSubTransition');
...
class DocumentFactory {
  ...
  createStateTransition(documents) {
    ...
    const createDocumentSubTransitions = (createDocuments || [])
      .map((document) => new CreateSubTransition({
        $id: document.getId(),
    ...
    const replaceDocumentSubTransitions = (replaceDocuments || [])
      .map((document) => new ReplaceSubTransition({
        $id: document.getId(),
        ...document.getData(),
      }));

    const deleteDocumentSubTransitions = (deleteDocuments || [])
      .map((document) => new DeleteSubTransition({
        $id: document.getId(),
      }));
