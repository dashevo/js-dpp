...
const documentBatchTransitionSchema = require('../../schema/document/stateTransition/documentsBatch.json');
...
class DocumentFactory {
  ...
  createStateTransition(documents) {
    ...
    const protocolVersion = documentBatchTransitionSchema.properties.protocolVersion.maximum;
