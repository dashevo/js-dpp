 ...
 */
function validateIdentityTopUpTransitionDataFactory(validateLockTransaction, validateIdentityExistence) {
  /**
   *
   * For later versions:
  ...
  async function validateIdentityTopUpTransitionData(identityTopUpTransition) {
    ...
    result.merge(await validateIdentityExistence(identityTopUpTransition.getIdentityId()));
