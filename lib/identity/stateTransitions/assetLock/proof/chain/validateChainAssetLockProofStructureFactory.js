...
const InvalidIdentityAssetLockProofOutPointTransactionError = require('../../../../../errors/InvalidIdentityAssetLockProofOutPointTransactionError');
...
function validateChainAssetLockProofStructureFactory(
  ...
  async function validateChainAssetLockProofStructure(
    ...
    if (currentCoreChainLockedHeight > proofCoreChainLockedHeight) {
      result.addError(
        new InvalidIdentityAssetLockProofHeightError(
    ...
    if (!await stateRepository.isAssetLockTransactionOutPointNotUsed(outPointBuffer)) {
    ...
    try {
      ...
      result.addError(new InvalidIdentityAssetLockProofOutPointTransactionError(outPointBuffer));
    }
