...
class IdentityFactory {
  ...
  createIdentityCreateTransition(identity) {
    ...
    const protocolVersion = identityCreateTransitionSchema.properties.protocolVersion.maximum;
  ...
  createIdentityTopUpTransition(identityId, lockedOutPointBuffer) {
    ...
    const protocolVersion = identityTopUpTransitionSchema.properties.protocolVersion.maximum;
