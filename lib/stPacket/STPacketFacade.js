...
class STPacketFacade {
  ...
  create(items) {
    ...
    if (!dpContract) {
      throw new MissingOptionError(
        'dpContract',
        'Can\'t create ST Packet because Contract is not set, use setDPContract method',
      );
    }
  ...
  validate(stPacket) {
    ...
    if (!dpContract) {
      throw new MissingOptionError(
        'dpContract',
        'Can\'t validate ST Packet because Contract is not set, use setDPContract method',
      );
    }
