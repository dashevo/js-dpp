...
/**
 * Apply data contract state transition to data contract model
 *
 * @typedef applyDataContractStateTransitionToModel
 *
 ...
 */
function applyDataContractStateTransitionToModel(stateTransition, dataContract) {
...
module.exports = applyDataContractStateTransitionToModel;
