...
class DataContractCreateTransition extends AbstractStateTransitionIdentitySigned {
  /**
   * @param {RawDataContractCreateTransition} rawDataContractStateTransition
   */
  constructor(rawDataContractStateTransition) {
    super(rawDataContractStateTransition);

    const dataContract = new DataContract(rawDataContractStateTransition.dataContract);

    this.setDataContract(dataContract);

    this.entropy = rawDataContractStateTransition.entropy;
  }
