...
function buildEncodedPropertiesMap(schema, propertyName = undefined) {
  ...
  //
  // {
  //   "firstLevel.secondLevel": { ...property constraints },
  //   "firstLevel.secondLevel.third[0].property": { ...property constraints },
  // }
  //
  // of every property that have `contentEncoding` constraint
