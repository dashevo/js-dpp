...
const applyDataContractStateTransition = require('./stateTransition/applyDataContractStateTransitionToModel');
...
class DataContractFacade {
   ...
   */
  applyStateTransition(stateTransition, dataContract) {
    return applyDataContractStateTransition(stateTransition, dataContract);
  }
}
