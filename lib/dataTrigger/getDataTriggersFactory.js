...
const rejectDeleteDataTrigger = require('./dpnsTriggers/rejectDeleteDataTrigger');
const rejectUpdateDataTrigger = require('./dpnsTriggers/rejectUpdateDataTrigger');
